...
namespace MyTaxi.Web.Migrations
{
    ...
    [Migration("20200625212422_AddTripAndTripDatails")]
    partial class AddTripAndTripDatails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyTaxi.Web.Data.Entities.TaxiEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyTaxi.Web.Data.Entities.TripEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyTaxi.Web.Data.Entities.TripEntity", b =>
                {
                    b.HasOne("MyTaxi.Web.Data.Entities.TaxiEntity", "Taxi")
                        .WithMany("Trips")
            ...
            modelBuilder.Entity("Taxi.Web.Data.Entities.TripDetailEntity", b =>
                {
                    b.HasOne("MyTaxi.Web.Data.Entities.TripEntity", "Trip")
